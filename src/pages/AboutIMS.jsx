...
const instituteHighlights = [
  ...
  },
  {
    ...
    body:
      'The institute houses advanced diagnostic and treatment infrastructure including 3 Tesla 48 channel MRI, 256 Slice Dual Source CT Scan, High Energy Linear Accelerator, HDR Brachytherapy, modular laminar flow OTs, critical care units, Cath Lab with DSA, the SSI Mantra Surgical System, and high-tech clinical laboratories.'
  },
  {
      ...
      <motion.div initial="initial" animate="in" exit="out" variants={pageVariants} className="content-shell medium-shell cinematic-page">
        ...
        >
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
            ...
            <p style={{ fontSize: '1.2rem', lineHeight: 1.65, color: 'var(--text-secondary)', marginBottom: '20px' }}>
              Its advanced facilities include 3 Tesla 48 channel MRI, 256 Slice Dual Source CT Scan, High Energy Linear Accelerator, HDR Brachytherapy, 19 modular laminar flow OTs, critical care units, Cath Lab with DSA, SSI Mantra Surgical System, computerized labs, and a blood bank with component separation facility.
            </p>
