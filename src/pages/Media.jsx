      ...
      >
        <div className="section-card neon-outline" style={{ padding: 'clamp(30px, 6vw, 60px)', maxWidth: '760px', width: '100%', textAlign: 'center' }}>
          <div style={{ marginBottom: '24px' }}>
            <i className="fa-solid fa-photo-film" style={{ fontSize: '4rem', color: '#06b6d4', filter: 'drop-shadow(0 0 15px rgba(6, 182, 212, 0.4))' }}></i>
          </div>
          <h1 style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)', marginBottom: '20px' }}>
            Media <span className="gradient-text">Section</span>
          </h1>
          <div style={{
            display: 'inline-flex',
            alignItems: 'center',
